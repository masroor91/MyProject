...
//		Client c = Client.create(clientConfig);
		...
		String uri="http://localhost:8080/JerseyEmployeeServiceXml/rest/employeeService/getEmployeeById/100";
		WebResource resource1 = c.resource(uri);
		Employee emp=resource1.accept(MediaType.APPLICATION_XML).get(Employee.class);
