...
//		Client c= Client.create(clientConfig);
		...
		String uri="http://localhost:8080/JerseyEmployeeServiceXml/rest/employeeService/getAllEmployee";
...
//		List<Employee> employees=response.getEntity(new GenericType<ArrayList<Employee>>(){});
		...
		List<Employee> employees=resource1.accept("application/xml").get(new GenericType<ArrayList<Employee>>(){});
